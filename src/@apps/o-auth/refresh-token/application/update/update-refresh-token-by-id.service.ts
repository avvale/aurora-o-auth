...
@Injectable()
export class UpdateRefreshTokenByIdService
{
    constructor(
    ...
    ): Promise<void>
    {
        ...
        // update by id
        await this.repository.updateById(refreshToken, { constraint, cQMetadata, updateByIdOptions: cQMetadata?.repositoryOptions });
