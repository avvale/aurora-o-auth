...
@Injectable()
export class UpdateAccessTokenByIdService
{
    constructor(
    ...
    ): Promise<void>
    {
        ...
        // update by id
        await this.repository.updateById(accessToken, { constraint, cQMetadata, updateByIdOptions: cQMetadata?.repositoryOptions });
