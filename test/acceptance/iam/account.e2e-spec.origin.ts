...
describe('account', () =>
{
        ...
        return request(app.getHttpServer())
            ...
            .send({
                query:
                {
                    where:
                    {
                        id: '2b3b15d2-8970-464c-9025-3535cd96f51a',
                    },
                },
            })
            .expect(404);
    ...
    {
        return request(app.getHttpServer())
            .get('/iam/account/find/c030facf-a819-4a20-8be6-1c4c8d72f61f')
            .set('Accept', 'application/json')
            .expect(404);
    });
    ...
    test('/REST:PUT iam/account/update - Got 404 Not Found', () =>
    {
        return request(app.getHttpServer())
            ...
            .send({
                ...mockData[0],
                id: '5ada62bb-11f7-469a-bbed-73c585fc2ae5',
            })
            .expect(404);
    });
    ...
    {
        return request(app.getHttpServer())
            .delete('/iam/account/delete/b6189531-5986-4511-8513-75fe7bda01e4')
            .set('Accept', 'application/json')
            .expect(404);
    });
            ...
            .send({
                ...
                variables:
                {
                    query:
                    {
                        where:
                        {
                            id: 'f8c70866-f91d-4a20-a118-6a3f16363adc',
                        },
                    },
                },
            })
    ...
    test('/GraphQL iamFindAccountById - Got 404 Not Found', () =>
    {
        return request(app.getHttpServer())
            ...
            .send({
                ...
                `,
                variables: {
                    id: '07a5a1a2-e96b-429f-bb79-7d70216dffac',
                },
            })
            .expect(200)
            .then(res =>
        ...
        return request(app.getHttpServer())
            ...
            .send({
                ...
                variables: {
                    payload: {
                        ...mockData[0],
                        id: '847f2ab7-02e7-4cdb-b3f8-5391da77b7d6',
                    },
                },
            })
            .expect(200)
    ...
    test('/GraphQL iamDeleteAccountById - Got 404 Not Found', () =>
    {
        return request(app.getHttpServer())
            ...
            .send({
                ...
                `,
                variables: {
                    id: '4d4a4bc5-f148-41b3-b289-8c4106a5cb9f',
                },
            })
            .expect(200)
            .then(res =>
